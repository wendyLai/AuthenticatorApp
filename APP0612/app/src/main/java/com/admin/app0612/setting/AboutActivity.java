 ...
 */
public class AboutActivity extends MyBasicActivity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.setting_activity);
        mySetActionBarTitle(R.string.action_bar_title_setting_about);
    ...
    private void addFragmentView() {
        ...
        SettingFragment settingFrag = new SettingFragment(R.xml.preference_about);
